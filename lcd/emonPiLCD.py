...
GPIO.setmode(GPIO.BOARD)                                 #Use Pi board pin numbers as these as always consistant between revisions 

GPIO.setup(16, GPIO.IN, pull_up_down = GPIO.PUD_DOWN)    #emonPi push button Pin 16 GPIO 23
